...
public class snetController {
    ...
    private static snetController mInstance;

    public static synchronized snetController getInstance() {
        if(mInstance == null) {
            mInstance = new snetController();
        }
        return mInstance;
    }
    ...
    public void execute(final snet requestNetwork, String method, String url, final String tag, final snet.RequestListener requestListener) {
